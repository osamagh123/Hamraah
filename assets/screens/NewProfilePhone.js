...
export default function NewProfilePhone() {
    ...
    <SafeAreaView>
     ...
     <Text mt='5' fontSize="20" color="white">Update Profile</Text>
        ...
        <View mt='5' p='3'>
            ...
            <Input h='50' color='white' borderColor='#E7EAEF'  mt='1' keyboardType='numeric' isDisabled value={user.phoneNumber} onChangeText={text => setPhone(text)}/>
            <Text mt='5' mb='1' color='white' fontSize='10' >Email</Text>
            <Input h='50' color='white' borderColor={errorEmail ? 'red.600' : '#E7EAEF'}  mt='1' value={user.email} onChangeText={text => setEmail(text)}/>
            <Center>
