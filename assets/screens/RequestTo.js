          ...
          <Text mt='5' color='white' textAlign='center' fontSize='24'>Select Destination (To)</Text>
                <View p='5' h='80' overflow='visible'>
                  ...
                  <GooglePlacesAutocomplete
                      ...
                      onPress={(data, details = null) => navigation.navigate('Request',{to: data.description})}
              ...
              <View style={{position: 'absolute', bottom: 120, alignItems: 'center', width: '100%'}}>
                <Button w={windowWidth >= 500 ? windowWidth/2 : '85%'} h='50' bgColor='transparent' borderWidth='1' borderRadius='8' borderColor='#00AFCD' _pressed={{backgroundColor: '#00AFCD'}} onPress={()=>{navigation.navigate('Request',{to: address})}}>
    ...
    function ChooseMap(){
      return(
        <View>
          ...
          {/* {disable ? (<View bgColor='danger.600'>
          ...
          <MapView
            ...
            <View style={{position: 'absolute', bottom: 120, alignItems: 'center', width: '100%'}}>
              <Button isDisabled={disable} w={windowWidth >= 500 ? windowWidth/2 : '85%'} h='50' bgColor='transparent' borderWidth='2' borderRadius='8' borderColor='#00AFCD' _pressed={{backgroundColor: '#00AFCD'}}  onPress={()=>{navigation.navigate('Request',{to: address})}}>
