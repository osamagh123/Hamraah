...
import { faCancel, faClose, faCross, faLocationDot, faSearch } from '@fortawesome/free-solid-svg-icons';

export default function ScheduledFrom() {
          ...
          <Text mt='5' color='white' textAlign='center' fontSize='24'>Select Destination (From)</Text>
                <View p='5' h='80' overflow='visible'>
                 ...
                 <GooglePlacesAutocomplete
                      ...
                      onPress={(data, details = null) => navigation.navigate('Scheduled',{from: data.description})}
              ...
              <View style={{position: 'absolute', bottom: 120, alignItems: 'center', width: '100%'}}>
                <Button w={windowWidth >= 500 ? windowWidth/2 : '85%'} h='50' bgColor='transparent' borderWidth='1' borderRadius='8' borderColor='#00AFCD' _pressed={{bgColor: '#00AFCD'}} onPress={()=>{navigation.navigate('Scheduled',{from: address})}}>
                  <Text fontSize='16' color='white'>Continue</Text>
                </Button>
              </View>
        </View>
      )
      ...
      return(
        <View>
          ...
          <MapView
            ...
            <View style={{position: 'absolute', bottom: 120, alignItems: 'center', width: '100%'}}>
              <Button isDisabled={disable} w={windowWidth >= 500 ? windowWidth/2 : '85%'} h='50' bgColor='transparent' borderWidth='2' borderRadius='8' borderColor='#00AFCD' _pressed={{bgColor: '#00AFCD'}} onPress={()=>{navigation.navigate('Scheduled',{from: address})}}>
