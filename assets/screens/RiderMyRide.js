...
import { Button, Center, HStack, Image, ScrollView, Text, View, Pressable } from 'native-base'
...
export default function RiderMyRide() {
    useFocusEffect(
        useCallback(() =>{
          const onBackPress = () =>{
            return true;
  ...
  const EndRideHandler = () => {
    ...
    .then(() => {
      ...
      navigation.navigate('RateRide',{RiderKey: rideData[0].key, ConsumerKey: consumerData[0].key});
      setLoading(false)
